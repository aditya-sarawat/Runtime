    ...
    <div className="w-full flex-grow flex flex-col bg-rich-black transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-12 md:py-20 flex flex-col gap-10 w-full text-left">
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-8 text-sm font-sans text-muted-gray leading-relaxed divide-y divide-charcoal">
            
            <div className="flex flex-col gap-3 pt-6 first:pt-0">
              <h2 className="text-base font-semibold text-off-white">1. Operational Licensing</h2>
              <p>
            ...
            <div className="flex flex-col gap-3 pt-6">
              <h2 className="text-base font-semibold text-off-white">2. Usage Guidelines & Limitations</h2>
              <p>
            ...
            <div className="flex flex-col gap-3 pt-6">
              <h2 className="text-base font-semibold text-off-white">3. Disclaimers & Limitations of Liability</h2>
              <p className="bg-card-bg p-4 border border-charcoal rounded-lg text-xs text-muted-gray">
